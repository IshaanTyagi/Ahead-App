  ...
  >
    ...
    >
      ...
      <div className="flex justify-between items-center flex-row relative z-10">
        ...
        <motion.p
          variants={fadeIn('up', 'tween', 0.2, 1)}
          className="mt-[8px] font-normal sm:text-[25px] text-[15px] text-center text-primary-black w-96"
        >
